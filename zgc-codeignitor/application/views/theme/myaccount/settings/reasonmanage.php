...
<div class="col-lg-9"> 
<ul class="menuBtn"><li><a href="<?php echo base_url('addreason'); ?>"> Add Reason </a></li></ul>
</div></div></div>
              ...
              <tr>
                ...
                <td><?php echo $sitelist->title; ?></td>
                                 ...
                                 <td>
<a class="btn btn-success btn-xs" href="<?php echo base_url('editreason/'.$sitelist->id); ?>" data-original-title="btn btn-danger btn-xs" title="">Edit</a>
