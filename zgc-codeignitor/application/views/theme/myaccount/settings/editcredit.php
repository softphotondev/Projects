...
<div class="col-lg-3"><h5><?php echo $title;?></h5> </div>
                    ...
                    <input type="hidden" name="id" id="id" value="<?php echo $creditlist->id; ?>">
                      ...
                      <div class="card-body">
                        ...
                        <input type="text" name="sites"  placeholder="Sites" class="form-control" required  value="<?php echo $creditlist->sites; ?>"  />
                          </div>
