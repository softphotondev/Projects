<div class="table-responsive" style="margin-top: 50px;">
						<table class="display" width="100%"  id="basic-4">
						  <thead>
							<tr role="row">
								<th>S.No</th>
								<th>Experian</th>
						  ...
						  <td>
							  <?php if($Response->exprian_pdf!='') { ?> 
								  <?php echo $expdate; ?>
									...
									<a href="<?php echo $Response->exprian_pdf; ?>" target="_blank">
									<i class="fa fa-eye view-eyes" aria-hidden="true"></i></a>
						  ...
						  <td>
							  ...
							  <?php echo $equidate; ?>
								  ...
								  <a href="<?php echo $Response->equifax_pdf; ?>" target="_blank"><i class="fa fa-eye view-eyes" aria-hidden="true"></i>
								  </a>
