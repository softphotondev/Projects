            ...
            <div class="card">
              <div class="row product-page-main">
                ...
                <div class="col-xl-8">
                  ...
                  <div class="m-t-15">
                    <button class="btn btn-primary-gradien m-r-10" type="button" data-original-title="Add To Cart" title="">Add To Cart</button>
                    <button class="btn btn-secondary-gradien m-r-10" type="button" data-original-title="Quick View" title="">Quick View</button>
                    <button class="btn btn-success-gradien" type="button" data-original-title="Buy Now" title="">Buy Now</button>
                  </div>
                </div>
              </div>
            </div>
