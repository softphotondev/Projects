			  ...
			  <div class="col-sm-3 col-xs-12">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<?php
						...
						?>
						<a class="thumb-col" href="#" onclick="getOrderStepDetail('<?php echo $order_id;?>','<?php echo $product_block_id;?>','<?php echo $b;?>','<?php echo $newcount;?>');" >
						<div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> <?php echo $block_name ;?></p> </a>
						<?php $b++;} ?>

						<a class="thumb-col" href="<?php echo site_url('projects/view/'.$order_id.'?tab=bottable');?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> BOT TABLE</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/createletter/'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> CREATE LETTER</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/letters'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> LETTER</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/innovis'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> INNOVIS</p> 
						</a>
						<a class="thumb-col" href="<?php echo site_url('order/botusps'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> USPS</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/lexisNexis'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p>LEXIS NEXIS</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/ftc'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> FTC</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/documents'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> DOCUMENTS</p></a>
						<a class="thumb-col" href="<?php echo site_url('order/tracking'.$order_id);?>"><div class="thumbImg"> <img src="<?php echo $img; ?>"></div> <p> TRACKING</p></a>
					</div>
				</div>
			  </div>
...
<div class="tab-pane fade" id="pills-client" role="tabpanel" aria-labelledby="pills-client-tab">
  ...
  ?>
    <div class="row">
            <div class="col-md-4 p-overview">      
        <h2 class="panel-heading project-info-bg no-radius">Client Details</h2>
<div class="panel-body no-radius">
         <table class="table table-borded no-margin">
                 <tbody>
                    <tr class="project-billing-type">
                    ...
                    <tr class="project-cost">
                      <td class="bold"><strong>CLIENT PHONE</strong></td>
                      <td><?php echo $phone; ?></td>
                    </tr>

                    <tr>
                      <td class="bold"><strong>BROKER NAME</strong></td>
                      <td><?php echo $brokername; ?></td>
                    </tr>
                    <tr>
                      <td class="bold"><strong>BROKER PHONE</strong></td>
                      <td><?php echo $brokerphone; ?></td>
                    </tr>

                     <tr>
                      <td class="bold"><strong>BROKER SITE URL</strong></td>
...
<div class="tab-pane fade" id="pills-credit" role="tabpanel" aria-labelledby="pills-credit-tab">
        <h2 class="panel-heading project-info-bg no-radius">Credit Report</h2>
                            ...
                            /* if($order_identity_report)
                             {
                               ...
                               {
                               	?>
<div id="credit_<?php echo $order_identity->id; ?>" style="border:2px solid #efefef;padding:25px;margin-top:20px;background:#fff;">
              <h4 class="order-card-title"> Credit Report </h4>
             <?php echo $order_identity->message; ?> </div>
            <?php } } */?>
