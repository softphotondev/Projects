<div class="page-body vertical-menu-mt">
  ...
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        <form name="addCMS" method="POST" action="<?php echo base_url('Support/replysave')?>"  enctype="multipart/form-data">
          ...
          <input type="hidden" name="status" value="<?php echo $support->status; ?>">
          <div class="subject-col">
            <div class="row">
              ...
              <div class="col-lg-3">
                <select class="custom-select" name="status" id="status"  onclick="supportchangestatus('1',this.value,'<?php  echo $support->support_id; ?>')">
          ...
          <a class="btn btn-secondary" href="<?php echo base_url('projects/view/'.$support->order_id); ?>" data-dismiss="modal">
          Back</a>
          </div>
        </form>
        ...
        <?php
        $comments = getallcomments($support->support_id); ?>
