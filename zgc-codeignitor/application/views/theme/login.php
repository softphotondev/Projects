...
.btn-register {     
background: #3e85e8 !important;
border: #3e85e8 solid 1px !important;}
.btn-register:hover { background:#d33 !important; border:#d33 solid 1px !important;}
.btn-login { background:#161b30 !important; border:#161b30 solid 1px !important;}
                    ...
                    <form id="loginformnew" action="<?php echo base_url('Site/login');?>" method="POST" >
                      ...
                      <div class="row">
                        <div class="form-group col-lg-6 col-sm-6 col-md-6">
						 ...
						 <div class="form-group col-lg-6 col-sm-6 col-md-6"><a href="<?php echo base_url('register'); ?>"  class="btn btn-primary btn-block btn-register"> REGISTER</a></div>
                      </div>
                    </form>
                  </div>
