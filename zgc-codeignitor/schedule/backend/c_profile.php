		  ...
		  <form name="rzvy_profile_form" id="rzvy_profile_form" method="post">
			  ...
			  <div class="form-group row">
				...
				<div class="col-md-6">
					...
					<input class="form-control" id="rzvy_profile_country" name="rzvy_profile_country" type="text" value="<?php echo $profile_data['country']; ?>" placeholder="<?php if(isset($rzvy_translangArr['enter_country'])){ echo $rzvy_translangArr['enter_country']; }else{ echo $rzvy_defaultlang['enter_country']; } ?>Enter Country" />
				</div>
			  </div>
