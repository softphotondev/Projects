...
?>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="<?php echo SITE_URL; ?>backend/support-tickets.php"><?php if(isset($rzvy_translangArr['support_tickets'])){ echo $rzvy_translangArr['support_tickets']; }else{ echo $rzvy_defaultlang['support_tickets']; } ?></a>
        </li>
      ...
      <div class="card mb-3">
        <div class="card-header">
		  ...
		  <a class="btn btn-primary btn-sm rzvy-white pull-right" href="<?php echo SITE_URL; ?>backend/support-tickets.php"><i class="fa fa-angle-double-left"></i> <?php if(isset($rzvy_translangArr['back_to_support_tickets'])){ echo $rzvy_translangArr['back_to_support_tickets']; }else{ echo $rzvy_defaultlang['back_to_support_tickets']; } ?></a>
		</div>
        <div class="card-body">
