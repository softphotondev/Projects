...
if($cs_asash == "custom"){
	?>
	<style>
	.rzvy{ background-color: <?php echo $cs_asash_pcolor; ?> !important; } 
	.rzvy .breadcrumb{ background-color: <?php echo $cs_asash_scolor; ?> !important; } 
	.rzvy .rzvy-content-wrapper{ background-color: <?php echo $cs_asash_bgcolor; ?> !important; color: <?php echo $cs_asash_tcolor; ?> !important; } 
	.rzvy #rzvy-mainnav{ background-color: <?php echo $cs_asash_pcolor; ?> !important; } 
	.rzvy #rzvy-mainnav.navbar-dark .navbar-collapse .navbar-sidenav{ background: <?php echo $cs_asash_pcolor; ?> !important; } 

	.rzvy #rzvy-mainnav a.navbar-brand,
	.rzvy #rzvy-mainnav.navbar-dark .navbar-collapse .navbar-sidenav > .nav-item > .nav-link:hover,
	.rzvy #rzvy-mainnav.navbar-dark .navbar-collapse .navbar-sidenav > .nav-item > .nav-link{ color: <?php echo $cs_asash_tcolor; ?> !important; }
	...
	#rzvy-menu-accordion .nav-item.rzy_active{ background: <?php echo $cs_asash_scolor; ?> !important; } 
	
	#rzvy-mainnav .navbar-collapse .navbar-nav .nav-item .nav-link{ color: <?php echo $cs_asash_tcolor; ?> !important; }
	#rzvy-mainnav .navbar-collapse .navbar-nav .nav-item .nav-link:hover,
	#rzvy-mainnav .navbar-collapse .navbar-nav .nav-item .nav-link.rzy_active{ color: <?php echo $cs_asash_scolor; ?> !important; } 
