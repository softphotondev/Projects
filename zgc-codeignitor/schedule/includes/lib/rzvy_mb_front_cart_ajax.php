...
/* refresh cart sidebar ajax */
	...
	if($_SESSION['rzvy_mb_cart_service_id']!="" && $_SESSION['rzvy_mb_cart_service_id']>0){
		...
		<ul class="rzvy_cart_items_list">
			...
			<li class="rzvy_cart_items_list_li">
				...
				<p>
					...
					<span class="pull-right"><?php echo $rzvy_currency_symbol.$_SESSION['rzvy_mb_cart_subtotal']; ?></span>
				</p>
			</li>
			<?php 
			if($_SESSION['rzvy_mb_cart_freqdiscount']>0){ 
				...
				<li class="rzvy_cart_items_list_li">
					...
					<p>
						...
						<span class="pull-right">-<?php echo $rzvy_currency_symbol.$_SESSION['rzvy_mb_cart_freqdiscount']; ?></span>
					</p>
				</li>
			<?php 
			} 
			if($_SESSION['rzvy_mb_cart_coupondiscount']>0){ 
				...
				<li class="rzvy_cart_items_list_li">
					...
					<p>
						...
						<span class="pull-right">-<?php echo $rzvy_currency_symbol.$_SESSION['rzvy_mb_cart_coupondiscount']; ?></span>
					</p>
				</li>
			<?php 
			} 
			if($_SESSION['rzvy_mb_cart_tax']>0){ 
				...
				<li class="rzvy_cart_items_list_li">
					...
					<p>
						...
						<span class="pull-right">+<?php echo $rzvy_currency_symbol.$_SESSION['rzvy_mb_cart_tax']; ?></span>
					</p>
				</li>
				<?php 
			} 
		...
		<h4><?php if(isset($rzvy_translangArr['net_total'])){ echo $rzvy_translangArr['net_total']; }else{ echo $rzvy_defaultlang['net_total']; } ?><span><?php echo $rzvy_currency_symbol.$_SESSION['rzvy_mb_cart_nettotal']; ?></span></h4>
		<?php 
	}else{ 
		?>
