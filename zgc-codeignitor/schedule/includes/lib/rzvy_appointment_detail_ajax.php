		...
		<div class="rzvy-tabbable-line">
			<ul class="nav nav-tabs">
			  <li class="nav-item active custom-nav-item">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_appointment_detail_link" data-tabno="0" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-calendar-check-o"></i> <?php if(isset($rzvy_translangArr['appointment_detail'])){ echo $rzvy_translangArr['appointment_detail']; }else{ echo $rzvy_defaultlang['appointment_detail']; } ?></a>
			  </li>
			  <li class="nav-item custom-nav-item">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_payment_detail_link" data-tabno="1" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-money"></i> <?php if(isset($rzvy_translangArr['payment_detail'])){ echo $rzvy_translangArr['payment_detail']; }else{ echo $rzvy_defaultlang['payment_detail']; } ?></a>
			  </li>
			  <li class="nav-item custom-nav-item">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_customer_detail_link" data-tabno="2" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-user"></i> <?php if(isset($rzvy_translangArr['customer_detail'])){ echo $rzvy_translangArr['customer_detail']; }else{ echo $rzvy_defaultlang['customer_detail']; } ?></a>
			  </li>
			  ...
			  <li class="nav-item custom-nav-item <?php if($appointment_status == "rejected_by_you" || $appointment_status == "cancelled_by_customer" || $appointment_status == "rejected_by_staff" || $appointment_status == "completed"){ echo "rzvy-hide"; } ?>">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_reschedule_appointment_link" data-tabno="5" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-pencil"></i> <?php if(isset($rzvy_translangArr['reschedule_appointment'])){ echo $rzvy_translangArr['reschedule_appointment']; }else{ echo $rzvy_defaultlang['reschedule_appointment']; } ?></a>
			  </li>
			  <li class="nav-item custom-nav-item <?php if($appointment_status == "rejected_by_you" || $appointment_status == "rejected_by_staff" || $appointment_status == "cancelled_by_customer" || $appointment_status == "completed"){ echo "rzvy-hide"; } ?>">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_reject_appointment_link" data-tabno="6" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-ban"></i> <?php if(isset($rzvy_translangArr['reject_appointment'])){ echo $rzvy_translangArr['reject_appointment']; }else{ echo $rzvy_defaultlang['reject_appointment']; } ?></a>
			  </li>
			  <li class="nav-item custom-nav-item <?php if($appointment_status == "rejected_by_you" || $appointment_status == "cancelled_by_customer" || $appointment_status == "rejected_by_staff" || $appointment_status == "completed"){ echo "rzvy-hide"; } ?>">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_complete_appointment_link" data-tabno="7" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-calendar-check-o"></i> <?php if(isset($rzvy_translangArr['mark_as_completed'])){ echo $rzvy_translangArr['mark_as_completed']; }else{ echo $rzvy_defaultlang['mark_as_completed']; } ?></a>
			  </li>
			  <li class="nav-item custom-nav-item">
				<a class="nav-link custom-nav-link rzvy_tab_view_nav_link rzvy_feedback_appointment_link" data-tabno="8" data-toggle="tab" data-id="<?php echo $order_id; ?>" href="javascript:void(0)"><i class="fa fa-star"></i> <?php if(isset($rzvy_translangArr['rating_and_review'])){ echo $rzvy_translangArr['rating_and_review']; }else{ echo $rzvy_defaultlang['rating_and_review']; } ?></a>
			  </li>
			</ul>
		...
		while($appt = mysqli_fetch_assoc($all_detail)){
			...
			?>
			  ...
			  <div class="row rzvy-mb-5">
				...
				<div class="col-md-4">
					<input class="form-control" id="rzvy_appt_rs_date" name="rzvy_appt_rs_date" type="date" data-datetime="<?php echo $booking_datetime; ?>" value="<?php echo $booking_date; ?>" required />
				</div>
			  </div>
			  <div class="row rzvy-mb-5">
				<div class="col-md-3">
