...
(function (global, factory) {
  ...
  if(window.location.pathname.indexOf("backend/location-selector") != -1){
	  var rzvy_ouput_tab_text = '<p class="text-dark text-center"><b>[ It will display on location selector page of frontend ]</b></p>';
  }else if(window.location.pathname.indexOf("backend/refund") != -1){
	  var rzvy_ouput_tab_text = '<p class="text-dark text-center"><b>[ It will display on Refund Tab of customer dashboard ]</b></p>';
  }else {
	  var rzvy_ouput_tab_text = '';
  }
  var statusbar = renderer.create([
	  '<output class="note-status-output" aria-live="polite"/>',
	  '<div class="note-statusbar" role="status">',
	  '  <output class="note-status-output" aria-live="polite">'+rzvy_ouput_tab_text+'</output>',
